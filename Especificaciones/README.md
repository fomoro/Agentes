...
El [fundamento del Scope como enrutador](Scope/fundamento_scope_enrutador.md) es una explicación complementaria del diseño. La [validación por entorno](Scope/validacion_scope_por_entorno.md) define cómo comprobar el prototipo; todavía no se han ejecutado las pruebas.
...
| Scope | Primer entregable: contrato del Scope. | [Especificación](Scope/especificacion_scope.md), [fundamento del Scope como enrutador](Scope/fundamento_scope_enrutador.md) y [validación por entorno](Scope/validacion_scope_por_entorno.md). |
