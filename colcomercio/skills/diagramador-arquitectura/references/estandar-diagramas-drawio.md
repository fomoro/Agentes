...
| Zona | Frame | Detalle de entorno | Contenedor | Elemento | Leyenda | Estado |
|---|---|---|---|---|---|---|
| `<Zona>` | `<Frame o vacío>` | `<Suscripción, región u otro dato confirmado, o vacío>` | `<Contenedor o vacío>` | `<Tipo>` | `<Nombre visible>` | `<Estado>` |
...
- Usar **Detalle de entorno** solo para datos confirmados necesarios para aplicar la matriz de conectividad. Compartir un frame no confirma suscripción, región ni red.
...
- La orden de generar el Draw.io de una ficha existente aprueba esa versión para diagramación; no autoriza modificarla ni crear una copia normalizada.
- Conserva el archivo de origen y usa su mismo nombre base para el Draw.io.
- Trata los campos ausentes como información faltante, no como valores predeterminados. Si impiden aplicar una regla sin inferir, informa el pendiente y detén la generación.
